      {
        ...
        "panels": [
          {
            "content": "<h2><center><bold>User Changes</bold></center></h2>",
            "editable": true,
            "error": false,
            "id": 45,
            "isNew": true,
          ...
          },
          {
            ...
            "targets": [
              {
                "refId": "A",
                "target": "collectd.%HOST%.USER_CHANGES-Memory-perm_memory.count-used_percent"
              }
            ],
            "thresholds": "85,95",
          ...
          },
          {
            ...
            "targets": [
              {
                "target": "collectd.%HOST%.USER_CHANGES-GCParNew-gc_duration.count-duration",
                "refId": "A"
              }
            ],
            "links": [],
          ...
          },
          {
            ...
            "targets": [
              {
                "target": "collectd.monitoring-16-01.USER_CHANGES-CapConnection-su_sessions.count-sessions",
                "refId": "A"
              }
            ],
            "links": [],
