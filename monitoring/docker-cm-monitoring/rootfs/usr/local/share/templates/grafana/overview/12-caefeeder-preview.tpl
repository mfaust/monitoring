      {
        ...
        "panels": [
          {
            "content": "<h3><center><bold>Feeder Preview</bold></center></h3>",
            "editable": true,
            "error": false,
            "id": 33,
            "isNew": true,
          ...
          },
          {
            ...
            "targets": [
              {
                "refId": "A",
                "target": "collectd.%HOST%.FEEDER_PREV-Memory-perm_memory.count-used_percent"
              }
            ],
            "thresholds": "85,95",
          ...
          },
          {
            ...
            "targets": [
              {
                "target": "collectd.%HOST%.FEEDER_PREV-GCParNew-gc_duration.count-duration",
                "refId": "A"
              }
            ],
            "links": [],
