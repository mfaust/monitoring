      {
        ...
        "panels": [
          {
            "content": "<h3><center><bold><a href=\"/grafana/dashboard/db/%SHORTHOST%-preview-cae\">CAE Preview</a></bold></center></h3>",
            "editable": true,
            "error": false,
            "id": 45,
            "isNew": true,
          ...
          },
          {
            ...
            "targets": [
              {
                "target": "collectd.%HOST%.CAE_PREV-Runtime-uptime.uptime",
                "refId": "A",
                "textEditor": false
              }
            ],
          ...
          },
          {
            ...
            "targets": [
              {
                "target": "collectd.%HOST%.CAE_PREV-CapConnection-su_sessions.count-sessions",
                "refId": "A"
              }
            ],
            "links": [],
