      {
        ...
        "panels": [
          {
            "content": "<h3><center><bold>Feeder Live</bold></center></h3>",
            "editable": true,
            "error": false,
            "id": 27,
            "isNew": true,
          ...
          },
          {
            ...
            "targets": [
              {
                "refId": "A",
                "target": "collectd.%HOST%.FEEDER_LIVE-Memory-perm_memory.count-used_percent"
              }
            ],
            "thresholds": "85,95",
          ...
          },
          {
            ...
            "targets": [
              {
                "target": "collectd.%HOST%.FEEDER_LIVE-GCParNew-gc_duration.count-duration",
                "refId": "A"
              }
            ],
            "links": [],
          ...
          },
          {
            ...
            "targets": [
              {
                "target": "collectd.%HOST%.FEEDER_LIVE-Health-feeder.absolute-healthy",
                "refId": "A"
              }
            ],
            "links": [],
