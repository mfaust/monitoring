      {
        ...
        "panels": [
          {
            "content": "<h3><center><bold>Content Feeder</bold></center></h3>",
            "editable": true,
            "error": false,
            "id": 20,
            "isNew": true,
          ...
          },
          {
            ...
            "targets": [
              {
                "refId": "A",
                "target": "collectd.%HOST%.FEEDER_CONTENT-Memory-perm_memory.count-used_percent"
              }
            ],
            "thresholds": "85,95",
          ...
          },
          {
            ...
            "targets": [
              {
                "target": "collectd.%HOST%.FEEDER_CONTENT-GCParNew-gc_duration.count-duration",
                "refId": "A"
              }
            ],
            "links": [],
