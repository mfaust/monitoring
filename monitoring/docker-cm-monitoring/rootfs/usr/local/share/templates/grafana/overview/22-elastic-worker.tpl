      {
        ...
        "panels": [
          {
            "content": "<h3><center><bold><a href=\"/grafana/dashboard/db/%SHORTHOST%-elastic-worker\">Elastic Worker</a></bold></center></h3>",
            "editable": true,
            "error": false,
            "id": 45,
            "isNew": true,
          ...
          },
          {
            ...
            "targets": [
              {
                "target": "collectd.%HOST%.ELASTIC_WORKER-Runtime-uptime.uptime",
                "refId": "A",
                "textEditor": false
              }
            ],
