...
#    service_problems_handled_all, service_problems_handled_warning, service_problems_handled_critical, service_problems_handled_unknown = icinga.service_problems_handled.values
    ...
    color_hosts_down_adjusted       = hosts_down_adjusted.to_i == 0 ? 'green' : 'red'
    color_services_handled_critical = service_problems_handled_critical.to_i == 0 ? 'green' : 'red'
    color_services_handled_warning  = service_problems_handled_warning.to_i == 0 ? 'green' : 'yellow'
    color_services_handled_unknown  = service_problems_handled_unknown.to_i == 0 ? 'green' : 'purple'
